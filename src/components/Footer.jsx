  ...
  return (
    <div className="bg-primary text-white">
      <footer className="footer place-items-center p-10 ">
        <div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div>
              <h2 className="text-xl font-bold capitalize">Lingo Bingo</h2>
              <p>Learning language Worldwide</p>
              ...
              <p className="flex items-center gap-2">
                <FaPhone />
                <span className="font-bold">Phone:</span> +8806926354
              </p>
      ...
      <p className="text-center py-8 ">
        Copyright © {new Date().getFullYear()} - All right reserved by Md. Arif
        Hassan
      </p>
    </div>
  );
